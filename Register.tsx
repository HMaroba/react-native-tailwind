    ...
    <View className="flex-1 items-center justify-center bg-white">
      ...
      <View className="w-full p-10 space-y-5">
        ...
        <View className="w-full justify-center items-center">
          <Text className="text-2xl text-end">Our Menu</Text>
          <View className="grid grid-cols-3 gap-4 w-full">
            <View className="bg-blue-600 min-h-10 w-full">
              <Text>Pay</Text>
            </View>
            <View className="bg-blue-600 min-h-10">
            <Text>Pay</Text>
            </View>
            <View className="bg-blue-600 min-h-10">
            <Text>Pay</Text>
